...
module.exports = function () {
	...
	return {
		...
		createDatabase: function () {
			...
			sequelize.query('DROP DATABASE IF EXISTS ' + config.db.name + ';').then(function () {
				sequelize.query('CREATE DATABASE ' + config.db.name + ';').then(function () {
					sequelize.close();
					dfd.resolve();
				});
			});
		...
		deleteDatabase: function () {
			this.connectToInstance().query('DROP DATABASE IF EXISTS ' + config.db.name + ';');
		},
